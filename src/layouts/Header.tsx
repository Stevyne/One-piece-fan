...
const tabs = [
  ...
  { id: 'timeline', path: '/timeline', label: 'Timeline', emoji: '🧭' },
];
        ...
        <div className="flex items-center justify-between gap-4">
          <NavLink to="/" className="flex items-center gap-3 shrink-0">
            ...
            <div className="hidden md:block">
              ...
              <p className="text-[10px] text-white/40 tracking-widest uppercase -mt-0.5">Grand Line Explorer • v1.1 • {tabs.length} sections</p>
            </div>
          </NavLink>
          ...
          <nav className="flex gap-1 overflow-x-auto scrollbar-none" role="tablist" aria-label="Sections">
            {tabs.map(tab => (
              <NavLink
                ...
                to={tab.path}
                className={({ isActive }) =>
                  `px-2.5 sm:px-3 py-2 rounded-lg text-[11px] sm:text-sm font-bold transition-all duration-300 whitespace-nowrap flex items-center gap-1 ${
                    isActive
